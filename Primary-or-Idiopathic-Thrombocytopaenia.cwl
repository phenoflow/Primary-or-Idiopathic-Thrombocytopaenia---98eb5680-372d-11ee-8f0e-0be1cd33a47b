...
steps:
  ...
  primary-or-idiopathic-thrombocytopaenia---secondary:
    run: primary-or-idiopathic-thrombocytopaenia---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: primary-or-idiopathic-thrombocytopaenia---secondary/output
class: Workflow
inputs:
  potentialCases:
    id: potentialCases
